...
type Storage interface {
	...
	Clone(ctx context.Context) Storage
	...
	SaveAuthorize(ctx context.Context, authData *AuthorizeData) error
	...
	SaveAccess(ctx context.Context, accessData *AccessData) error
